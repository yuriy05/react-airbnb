  ...
  return (
        <Page>
            ...
            <Amenities title="Зручності" 
              ...
              baby={data.amenities.hasChildFriendly}
              />
            <Contact 
            ...
            />
            <Review title="Відгуки клієнтів" list={data.guestReviews} />
            <Attractions title="Пам'ятки поблизу" nearbyAttractions={data.nearbyAttractions} />
         </Page>
  );        
}
